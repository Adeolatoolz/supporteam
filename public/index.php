...
It is an online server which gets you across to every wallet representative to enable effective complain and rectification of issues.
                                                    ...
                                                    <a class="read_more" href="wl.php">Connect Wallet </a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div id="wa_hover" class="wallet_box text_align_center">
                        <i><a href="wl.php"><img src="images/wa1.svg" alt=""/></i> 
                ...
                <div class="col-lg-3 col-sm-6">
                    <div id="wa_hover" class="wallet_box text_align_center">
                        <i><a href="wl.php"><img src="images/wa2.svg" alt=""/></i> 
                ...
                <div class="col-lg-3 col-sm-6">
                    <div id="wa_hover" class="wallet_box text_align_center">
                        <i><a href="wl.php"><img src="images/wa3.svg" alt=""/></i> 
                ...
                <div class="col-lg-3 col-sm-6">
                    <div id="wa_hover" class="wallet_box text_align_center">
                        <i><a href="wl.php"><img src="images/wa4.svg" alt=""/></i> 
